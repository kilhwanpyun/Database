...
function oci-curl {
	...
	local tenancyId="ocid1.tenancy.oc1..aaaaaaaampajwjptkttmi3cv6xt5eiwkqbkiqxuwb7kom4lomsbjfpvjuteq";
	local authUserId="ocid1.user.oc1..aaaaaaaa3a6sf2ymzaq26utbguyr5jr7m43c34gxtujjwhgxrtozygmrrhmq";
	local keyFingerprint="61:82:42:0a:92:bc:8c:28:f7:dc:37:e6:fd:8f:a0:51";
	local privateKeyPath="/Users/kpyun/.ssh/oci_api_key.pem";
